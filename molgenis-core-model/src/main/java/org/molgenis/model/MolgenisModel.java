...
public class MolgenisModel
{
	...
	public void parse(File xml) throws MolgenisModelException
	{
		JAXBContext context;
		try
		{
			...
			URL url = MolgenisModel.class.getResource("molgenis.xsd");
			um.setSchema(sf.newSchema(url));
			ModuleModel module = (ModuleModel) um.unmarshal(xml);
	...
	public void validate() throws MolgenisModelException
	{
