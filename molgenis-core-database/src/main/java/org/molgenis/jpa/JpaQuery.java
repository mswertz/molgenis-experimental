...
//package org.molgenis.database.jpa;
//
...
//
//import org.molgenis.database.DatabaseException;
//import org.molgenis.database.IdentifiableEntity;
//import org.molgenis.database.Query;
//import org.molgenis.database.QueryRule;
//
//public class JpaQuery<E extends IdentifiableEntity> extends Query implements Iterable<E>
//{
//	private Class<E> klass;
//
//	// container of our entity manager etc
//	private JpaDatabase backend;
//
...
//	}
//
//	public JpaQuery(Class<E> klass, JpaDatabase backend)
//	{
//		this.klass = klass;
...
//		if(this.getLimit()>0)tq.setMaxResults(getLimit());
//		if(this.getOffset()>0)tq.setFirstResult(getOffset());
//		return tq.getResultList().iterator();
//	}
//
//	public E getById(Object id) throws DatabaseException
//	{
//		// todo
