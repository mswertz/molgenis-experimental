...
public interface Backend
{
	 ...
	 */
	<E extends IdentifiableRecord> E getById(Class<E> klass, Object id);

	<E extends IdentifiableRecord> E getByLabel(Class<E> klass, String label);
	 ...
	 * @throws BackendException
	 */
	IdentifiableRecord getById(String collection, Object id);
	 ...
	 */
	Query<? extends IdentifiableRecord> query(String collection);
	 ...
	 * @throws BackendException */
	<E extends IdentifiableRecord> E load(E object);
}