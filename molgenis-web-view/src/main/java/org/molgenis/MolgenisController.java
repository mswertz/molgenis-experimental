...
import org.molgenis.views.Info;
...
import org.molgenis.views.VerticalLayout;
import org.molgenis.views.View;
import org.molgenis.views.Warning;
...
public abstract class MolgenisController
{
	...
	public Form form(Entity entity)
	{
		return new Form(new VerticalLayout(), entity);
	}
	...
	public Table table(List<Entity> records)
	{
	...
	public Warning warn(String string)
	{
		return new Warning(string);
	}

	public Info info(String string)
	{
		return new Info(string);
	}

	public Success success(String string)
	{
		return new Success(string);
	}

	public Danger danger(String string)
	{
		return new Danger(string);
	}

	public Danger error(String string)
	{
		return new Danger(string);
	}

	public Show show(Entity e)
	{
		return new Show(e);
	}
	
	public VerticalLayout vertical(View<?> ...elements)
	{
